...
class NanoVNAV2(NanoVNA):
    ...
    def send_command(self, cmd):
        ...
        # self.serial.write([0x20,0xef,0x5e])
    ...
    def _updateSweep(self):
        ...
        # self.serial.write([0x20,0x44,0x01])
        # self.serial.write([0x20,0x40,0x03])
        # self.serial.write([0x20,0xE0,0x01])
        # self.serial.write([0x20,0xE1,0x01])
    ...
    def _scan(self):
        ...
        # cmd: write average (faster sweep)
        self.serial.write([0x20, 0x40, 0x00])

        # cmd: read FIFO, addr 0x30
        self.serial.write([0x18, 0x30, self.points])

        # cmd: write bandwidth (max possible speed)
        # self.serial.write([0x20,0x44,0x01])
        # self.serial.write([0x20,0x40,0x03])
        # self.serial.write([0x20,0xE0,0x01])
        # self.serial.write([0x20,0xE1,0x01])
